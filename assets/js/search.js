(function () {
    ...
    var endpoint = null
    var env = 'production'
    var elasticSearchIndex = 'opendocsg-opendoc-datagovsg-data-quality-guide'
    ...
    function getLunrIndex() {
        return fetch('/opendoc-datagovsg-data-quality-guide/assets/lunrIndex.json')
            .then(function (res) {
                    return res.json()
            })
            .then(function (json) {
    ...
    var generateResultHTML = function (result, i) {
        ...
        searchTitle.innerHTML = result.documentTitle || "Data.gov.sg Data Quality Guide"
