...
const BASEURL = 'opendoc-datagovsg-data-quality-guide'.replace('/', '')
...
const S3_PDF_FOLDER = 'opendocsg/opendoc-datagovsg-data-quality-guide'.replace(/\//g, '-') + (IS_PROD ? '' : '-staging')
